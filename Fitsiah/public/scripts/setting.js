document.addEventListener("DOMContentLoaded", function() {  //HTML 요소들 중 addEventListener에서 function()의 작용을 함 -> 그 function이 아래 2~5번째 줄의 작업
    document.getElementById("q2").classList.add("hidden"); //HTML의 ID 요소를 선택
...
function first() {
    const now_box = document.querySelector("#q1");
    const next_box = document.querySelector("#q2");
